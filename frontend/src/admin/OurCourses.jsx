...
function OurCourses() {
  ...
  return (
    <div className="bg-gray-100 p-8 space-y-4">
      ...
      <Link
        className="bg-blue-600 py-2 px-4 rounded-lg text-white hover:bg-blue-900 duration-300"
        to={"/admin/dashboard"}
      >
        Go to dashboard
      </Link>
          ...
          <div key={course._id} className="bg-white shadow-md rounded-lg p-4">
            ...
            <div className="flex justify-between">
              <Link
                ...
                className="bg-blue-600 text-white py-2 px-4 mt-4 rounded hover:bg-blue-900 duration-300 hover:text-white"
              >
                Update
              </Link>
              <button
                onClick={() => handleDelete(course._id)}
                className="bg-red-600 text-white py-2 px-4 mt-4 rounded hover:bg-red-900 duration-300 hover:text-white"
              >
                Delete
              </button>
            </div>

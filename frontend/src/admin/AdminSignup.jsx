      ...
      <div className="h-screen container mx-auto flex  items-center justify-center text-white">
        ...
        <header className="absolute top-0 left-0 w-full flex justify-between items-center p-5  ">
          ...
          <div className="flex items-center space-x-4">
            <Link
              to={"/admin/login"}
              className="bg-transparent text-black hover:bg-blue-900 border hover:text-white border-gray-500 py-2 px-4 rounded-md duration-300"
            >
              Login
            </Link>
            <Link
              to={"/courses"}
              className="bg-blue-600 hover:bg-blue-900 py-2 px-4 rounded-md duration-300"
            >
              Join now
            </Link>
          </div>
        ...
        {/* AdminSignup Form */}
        <div className="bg-gray-600 p-8 rounded-lg shadow-lg w-[500px] mt-20">
